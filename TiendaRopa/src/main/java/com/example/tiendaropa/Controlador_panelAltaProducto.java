...
public class Controlador_panelAltaProducto {
    ...
    public void mostrarAltaCamisa(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();

        Parent root = FXMLLoader.load(getClass().getResource("FXML_altaCamisa_Noor.fxml"));

        stage.setScene(new Scene(root));
        stage.show();
    }

    public void mostrarAltaChaqueta(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();

        Parent root = FXMLLoader.load(getClass().getResource("FXML_altaChaqueta_Noor.fxml"));

        stage.setScene(new Scene(root));
        stage.show();
    }

    public void mostrarAltaPantalon(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();

        Parent root = FXMLLoader.load(getClass().getResource("FXML_altaPantalon_Noor.fxml"));

        stage.setScene(new Scene(root));
        stage.show();
    }

    public void mostrarAltaBolso(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();

        Parent root = FXMLLoader.load(getClass().getResource("FXML_altaBolso_Noor.fxml"));

        stage.setScene(new Scene(root));
        stage.show();
    }

    public void mostrarAltaZapato(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();

        Parent root = FXMLLoader.load(getClass().getResource("FXML_altaZapato_Noor.fxml"));
