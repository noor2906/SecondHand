...
public class Controlador_altaChaqueta {
    ...
    @FXML
    private TextField txtfTallaAltaChaqueta, txtfColorAltaChaqueta, txtfTipoCierreAltaChaqueta;

    @FXML
    private CheckBox chBoxImpermeableAltaChaqueta;
    ...
    public void darAltaChaqueta(MouseEvent event) throws IOException {
        int ok = 0;
        int ok2 = 0;
        ...
        String talla = txtfTallaAltaChaqueta.getText();
        String color = txtfColorAltaChaqueta.getText();
        String tipoCierre = txtfTipoCierreAltaChaqueta.getText();
        boolean impermeable = chBoxImpermeableAltaChaqueta.isSelected();
        ...
        if(!nombre.equals("") && !precio.equals("") && !marca.equals("") && !descripcion.equals("") &&
            ...
            ok2 = InsercionesBBDD.insercionChaqueta(talla,color,tipoCierre, impermeable);
