...
public class Controlador_altaCamisa {
    ...
    @FXML
    private TextField  txtfTallaAltaCamisa, txtfColorAltaCamisa, txtfTipoCierreAltaCamisa, txtfTipoMangaAltaCamisa;

    @FXML
    private CheckBox chBoxEstampadaAltaCamisa;
    ...
    public void darAltaCamisa(MouseEvent event) throws IOException {
        ...
        //Propiedades camisa
        String talla = txtfTallaAltaCamisa.getText();
        String color = txtfColorAltaCamisa.getText();
        String tipoCierre = txtfTipoCierreAltaCamisa.getText();
        String tipoManga = txtfTipoMangaAltaCamisa.getText();
        boolean estampada = chBoxEstampadaAltaCamisa.isSelected();
        ...
        if(!nombre.equals("") && !precio.equals("") && !marca.equals("") && !descripcion.equals("") &&
                !imagen.equals("") && !material.equals("") && !talla.equals("") && !color.equals("") &&
                !tipoCierre.equals("") && !nombre.equals("") ){
            ...
            ok2 = InsercionesBBDD.insercionCamisa(talla,color,tipoCierre,tipoManga,estampada);
...
/*    public void setData(){
    ...
    //Botones limpieza camisa ------------------------------------------------------------------------------------------
    public void limpiarTalla(MouseEvent event) {
        txtfTallaAltaCamisa.clear();
    }
    public void limpiarColor(MouseEvent event) {
        txtfColorAltaCamisa.clear();
    }
    public void limpiarTipoCierre(MouseEvent event) {
        txtfTipoCierreAltaCamisa.clear();
    }
    public void limpiarTipoManga(MouseEvent event) {
        txtfTipoMangaAltaCamisa.clear();
    }
